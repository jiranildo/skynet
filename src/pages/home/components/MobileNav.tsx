    ...
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md border-t border-gray-200 z-50">
      <div className="flex items-center justify-around px-2 py-2 sm:py-3">
        <button
          ...
          className={`flex flex-col items-center gap-0.5 sm:gap-1 p-2 transition-colors ${activeTab === 'feed' ? 'text-orange-500' : 'text-gray-600'
            }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 sm:gap-1 p-2 transition-colors ${activeTab === 'explore' ? 'text-orange-500' : 'text-gray-600'
            }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 sm:gap-1 p-2 transition-colors ${activeTab === 'reels' ? 'text-orange-500' : 'text-gray-600'
            }`}
        >
